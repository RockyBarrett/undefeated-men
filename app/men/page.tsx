...
export default function HomePage() {
  ...
  const handleStart = () => {
    setStarted(true);
    try {
      // Unlock WebAudio for Typewriter on mobile
  ...
  return (
    <section className="hero">
      ...
      <h2>Motivation Quiz</h2>

      {/* START GATE — show this until user clicks */}
      {!started && (
        <div style={{ marginTop: "1rem" }}>
          <button className="cta-btn" onClick={handleStart} aria-label="Start intro">
            Start
          </button>
        </div>
      )}
            ...
            {showPower && (
              <div className="line">
                <Typewriter
                  ...
                  soundEnabled={true}
                  soundVolume={0.4}
                  onComplete={() => afterLine(500, () => setShowAffiliation(true))}
                />
              </div>
            )}
              ...
              <div className="line inline-line">
                ...
                {showCTA && (
                  <>
                    ...
                    <a href="/test" className="inline-cta" aria-label="Start the Quiz">
                      <button className="cta-btn-pulse">Start the Quiz</button>
                    </a>
                  </>
                )}
              </div>
